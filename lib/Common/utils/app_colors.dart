...
class AppColors {
  ...
  static const Color primaryElement = Color(0xffFFCC57);
  ...
  static const Color primaryElementText = Color.fromARGB(45, 43, 46, 1);
  ...
  static const Color documentButtonBg = Color(0xfffffaef);
