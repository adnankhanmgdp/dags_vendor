import 'package:dags/Features/HelpSupportScreen/view/widgets/help_widgets.dart';
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: SingleChildScrollView(
              ...
              const dashLine(),
              Container(
                margin: EdgeInsets.fromLTRB(20.w, 20.h, 20.w, 20),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    helpHeadingText(),
                    ...
                    Center(
                      child: Text(
                          ...
                          "For any other query or technical issue contact"),
                    ),
                    Center(
